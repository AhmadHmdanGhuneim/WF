...
namespace WF.ViewModels.Details
{
    public class SurpriseResultViewModel : ObservableObject, ICancellable
    {
        ...
        public SurpriseResultViewModel()
        {
            ...
            {
                GeneralFunctions.HandelException(exception, "SupriseResultViewModel");
            }
        }
        ...
        private async void Resend()
        {
            ...
            {
                GeneralFunctions.HandelException(exception, "SupriseResultViewModel : Resend");
            }
        }
        ...
        private void Show()
        {
            ...
            {
                GeneralFunctions.HandelException(exception, "SupriseResultViewModel : Show");
            }
        ...
        private async void Refresh()
        {
            ...
            {
                GeneralFunctions.HandelException(exception, "SupriseResultViewModel : Refreash");
            }
        }
        ...
        private async Task FillMasterSurprises()
        {
            ...
            {
                GeneralFunctions.HandelException(exception, "SupriseResultViewModel : FillMasterSurpises");
            }
        }
